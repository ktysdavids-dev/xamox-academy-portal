...
-- CreateEnum
CREATE TYPE "MaterialKind" AS ENUM ('PDF', 'IMAGE', 'VIDEO', 'LINK', 'OTHER');
...
CREATE TABLE "OneTimeLogin" (
    ...
    CONSTRAINT "OneTimeLogin_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "OneTimeLogin_token_key" ON "OneTimeLogin"("token");
